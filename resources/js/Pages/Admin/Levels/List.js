...
export default function List(props) {
  ...
  const fetchRows = () => {
    ...
    axios.get(route('admin.levels.fetch', { page: page > 0 ? page + 1 : null })).then((response) => {
      setIsLoading(false);
  ...
  const deleteLevel = (e, level) => {
    e.preventDefault();

    Swal.fire({
      title: 'Warning!',
      text: 'Are you sure you want to delete this level? Data cannot be retrieved once deleted.',
      icon: 'warning',
      ...
      if (chosenButton.isConfirmed) {
        axios.delete(route('admin.levels.destroy', level.id)).then((response) => {
            Swal.fire({
              title: 'Success !',
              text: response.data,
              icon: 'success',
    ...
    },
    {
      ...
      getActions: (params) => [
        <GridActionsCellItem
          ...
          label=""
          icon={
            <Link className="text-blue-600 rounded-full" href={route('admin.levels.show', params.id)}>
        ...
        <GridActionsCellItem
          ...
          label=""
          icon={
            <Link className="text-green-500 rounded-full" href={route('admin.levels.edit', params.id)}>
        ...
        <GridActionsCellItem
          ...
          label=""
          onClick={(e) => deleteLevel(e, params)}
            ...
            <div className="rounded-t bg-white mb-0 px-4 py-4">
              <div className="text-left flex items-start md:items-center justify-between flex-col md:flex-row">
                <div className="w-full md:w-auto mb-2 md:mb-0 flex lg:justify-center justify-center items-start md:items-center flex-col lg:flex-row">
                  <h6 className="text-black-600 text-lg font-semibold capitalize">Levels List</h6>
                </div>
