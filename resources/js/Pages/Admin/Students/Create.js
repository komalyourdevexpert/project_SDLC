...
export default function Create(props) {
  ...
  const submit = (e) => {
    ...
    formPayLoad.set('is_active', data.is_active);
    formPayLoad.set('is_private', data.is_private);
    if (data.profilePicture != null) {
      formPayLoad.append('profile_picture', data.profilePicture);
    }

    axios
      .post(route('admin.students.store'), formPayLoad)
      .then((response) => {
        setProcessing(false);
          Swal.fire({
            title: 'Success !',
        ...
        if (response.data.status === 'classMappingFailed') {
          Swal.fire({
            title: 'Failed !',
            text: 'A student can be part of only 1 class in 1 track.',
            icon: 'error',
          });
        }
      })
    ...
    <Authenticated auth={props.auth} errors={props.errors} header={'Students'}>
      <div className="flex flex-wrap justify-center">
        <div className="w-full xl:w-3/5">
          <form onSubmit={submit} id="formAddStudent">
            <div className="relative flex flex-col min-w-0 break-words w-full mb-4 md:mb-6 shadow-lg rounded-lg bg-gray-50 border-0">
              <div className="rounded-t bg-white mb-0 px-4 py-4">
                <div className="text-left flex items-start md:items-center justify-between flex-col md:flex-row">
                  <div className="w-full md:w-auto mb-2 md:mb-0 flex lg:justify-center justify-center items-start md:items-center flex-col lg:flex-row">
                    <h6 className="text-black-600 text-lg font-semibold capitalize">Add New Student</h6>
                  </div>
              ...
              <div className="flex-auto px-2 lg:px-3 py-6 pt-0 md:pt-0">
                <div className="flex flex-wrap mt-4">
                  ...
                  <div className="w-full lg:w-6/12 px-3">
                    <div className="relative w-full mb-3">
                      ...
                      <Select name="level_id" options={props.levels}></Select>
                  ...
                  <div className="w-full px-3">
                    <div className="relative w-full mb-3">
                      ...
                      <Select name="classes_id[]" options={props.classList} isMulti={true}></Select>
                    </div>
                  </div>
                  ...
                  <div className="w-full lg:w-6/12 px-3 mt-2">
                    <div className="relative w-full mb-3">
                      <label htmlFor="is_private" className="flex items-center">
                        <Checkbox name="is_private" value={data.is_private} handleChange={onHandleChange} />
