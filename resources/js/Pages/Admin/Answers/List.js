...
export default function List(props) {
  const deleteAnswer = (e, answer) => {
    e.preventDefault();

    Swal.fire({
      title: 'Warning!',
      text: 'Are you sure you want to delete this note? Data cannot be retrieved once deleted.',
      icon: 'warning',
      ...
      if (chosenButton.isConfirmed) {
        axios.delete(route('admin.answers.destroy', answer.id)).then((response) => {
            Swal.fire({
              title: 'Success !',
              text: response.data,
              icon: 'success',
  ...
  const fetchRows = () => {
    ...
    axios.get(route('admin.answers.fetch', { page: page > 0 ? page + 1 : null })).then((response) => {
      setIsLoading(false);
    ...
    },
    {
      ...
      getActions: (params) => [
        <GridActionsCellItem
          ...
          label=""
          icon={
            <Link className="text-blue-600 rounded-full" href={route('admin.answers.show', params.id)}>
        ...
        <GridActionsCellItem
          ...
          label=""
          icon={
            <Link className="text-green-500 rounded-full" href={route('admin.answers.edit', params.id)}>
        ...
        <GridActionsCellItem
          ...
          label=""
          onClick={(e) => deleteAnswer(e, params)}
            ...
            <div className="rounded-t bg-white mb-0 px-4 py-4">
              <div className="text-left flex items-start md:items-center justify-between flex-col md:flex-row">
                <div className="w-full md:w-auto mb-2 md:mb-0 flex lg:justify-center justify-center items-start md:items-center flex-col lg:flex-row">
                  <h6 className="text-black-600 text-lg font-semibold capitalize">Notes</h6>
                </div>
