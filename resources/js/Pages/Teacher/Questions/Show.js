          ...
          <div className="relative flex flex-col min-w-0 break-words w-full mb-4 md:mb-6 shadow-lg rounded-lg bg-gray-50 border-0">
            ...
            <div className="flex-auto bg-gray-100 p-4 md:p-6">
              <div className="bg-white shadow p-4 mx-auto w-full rounded">
                ...
                {props.question.type == 'descriptive' && (
                ...
                <div className="flex flex-col justify-between mt-6">
                  ...
                  <div className="tracking-wide">
                    Track Name:{' '}
                    <span className="text-blue-600 font-semibold capitalize">{props.question.track.name}</span>
                  </div>
                  <div className="tracking-wide">
                    Question Type: <span className="text-blue-600 font-semibold capitalize">{props.question.type}</span>
                  </div>
                </div>
              </div>
            </div>
